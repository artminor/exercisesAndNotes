...
public class AllTheMaths {
        ...
        /*
        when decimal is removed from 23.0 and 56.0 , 
        the answer changed to a less precise number
        8043.52 minus 4.2 plus 23.0 divided by 56.0 times -76.13 is: 8039.320000000001
        */
